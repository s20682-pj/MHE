...
vector<pair<int,int>> hillClimbingRandom(vector<pair<int, int>> data, int backpackSize, int iterations, int ifScript);
vector<pair<int,int>> tabuSearch(vector<pair<int, int>> data, int binSize, int tabuSize, int iterations, int ifScript);
